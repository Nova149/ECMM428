    ...
    public class TimetableTests
    {
        ...
        public bool CheckTimetablesAreEqual(Timetable timetable1, Timetable timetable2)
        {
            ...
            for (int i = 0; i < students1.Count; i++)
            {
                ...
                //Check lectures
                foreach (Course l1 in students1[i].GetLectures())
                {
                    int lectureNo = l1.GetNumber();
                    bool exists = false;
                    foreach (Course l2 in students2[i].GetLectures())
                    {
            ...
            for (int i = 0; i < lecturers1.Count; i++)
            {
                ...
                //Check lectures
                foreach (Course l1 in lecturers1[i].GetLectures())
                {
                    int lectureNo = l1.GetNumber();
                    bool exists = false;
                    foreach (Course l2 in lecturers2[i].GetLectures())
                    {
                        if (l2.GetNumber() == lectureNo)
                        {
                            exists = true;
            ...
            for (int i = 0; i < venues1.Count; i++)
            {
                ...
                //Check lectures
                Dictionary<int, Course> lectures1 = venues1[i].GetLectures();
                Dictionary<int, Course> lectures2 = venues2[i].GetLectures();
            ...
            for (int i = 0; i < modules1.Count; i++)
            {
                ...
                //Check lectures
                foreach (Course l1 in modules1[i].GetLectures())
                {
                    int lectureNo = l1.GetNumber();
                    bool exists = false;
                    foreach (Course l2 in modules2[i].GetLectures())
                    {
                        if (l2.GetNumber() == lectureNo)
                        {
                            exists = true;
                ...
                foreach (Course l1 in modules1[i].GetUnassignedLectures())
                {
                    int lectureNo = l1.GetNumber();
                    bool exists = false;
                    foreach (Course l2 in modules2[i].GetUnassignedLectures())
                    {
                        if (l2.GetNumber() == lectureNo)
                        {
                            exists = true;
