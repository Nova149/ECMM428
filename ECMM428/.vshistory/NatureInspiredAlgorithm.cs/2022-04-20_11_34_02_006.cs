...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static void Crossover(Timetable timetable1, Timetable timetable2, List<Lecture> timetable1lecturesChanged, List<Lecture> timetable2lecturesChanged, bool revertIfWorse)
        {
            ...
            for (int moduleIndex = 0; moduleIndex < modules1.Count; moduleIndex++)
            {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    if (lecture1Venue == null || lecture2Venue == null)
                    {
                        ...
                        bool improvedByNewLecture2 = timetable1InitialFitness < timetable2.GetFitness();
                        if (revertIfWorse)
                        {
                            ...
                            {
                                timetable1lecturesChanged.Add(lecture1);
                            }
                            ...
                            {
                                timetable2lecturesChanged.Add(lecture2);
                            }
                        }
                        else
                        {
                            ...
                            timetable1lecturesChanged.Add(lecture1);
                            timetable2lecturesChanged.Add(lecture1);
                        }
                        return;
                    }
                    else
                    {
                        ...
                        {
                            //Add lectures to lecturesChanged
                            if (timetable1lecturesChanged != null && improvedByNewLecture1)
                            {
                                timetable1lecturesChanged.Add(lecture1);
                            }
                            if (timetable2lecturesChanged != null && improvedByNewLecture2)
                            {
                                timetable2lecturesChanged.Add(lecture1);
                            }
                        }
