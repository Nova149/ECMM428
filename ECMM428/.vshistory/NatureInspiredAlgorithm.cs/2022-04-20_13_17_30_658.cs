...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
            ...
            for (int moduleIndex = 0; moduleIndex < modules1.Count; moduleIndex++)
            {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    if (lecture1Venue == null || lecture2Venue == null)
                    {
                        ...
                        //Generate transforms
                        if (improvedByNewLecture1) transform1 = new LectureTransform(lecture1, lecture1Venue, null, onlineLecture1Time, onlineLecture2Time);
                        if (improvedByNewLecture2) transform2 = new LectureTransform(lecture2, lecture2Venue, null, onlineLecture2Time, onlineLecture1Time);
                    ...
                    else
                    {
                        ...
                        //Generate transforms
                        if (improvedByNewLecture1) transform1 = new LectureTransform(lecture1, lecture1Venue, newVenue1, lecture1Time, lecture2Time);
                        if (improvedByNewLecture2) transform2 = new LectureTransform(lecture2, lecture2Venue, newVenue2, lecture2Time, lecture1Time);
                        return new LectureTransform[2] { transform1, transform2 };
                    }
                }
            }
        ...
        public static LectureTransform[] Mutation(Timetable timetable, List<int> lecturesChanged, bool revertIfWorse)
        {
                    ...
                    for (int lecture1Index = 0; lecture1Index < time1Lectures.Count; lecture1Index++)
                    {
                        ...
                        for (int courseIndex = 0; courseIndex < courses.Count; courseIndex++)
                        {
                            ...
                            if (lecture1Venue == null)
                            {
                                ...
                                //Generate transforms
                                if (improvedByNewLectures) transform1 = new LectureTransform(lecture1, lecture1Venue, null, lecture1Time, lecture2Time);
                                if (lecture2Swapped) transform2 = new LectureTransform(lecture2, lecture2Venue, null, lecture2Time, lecture1Time);
                                return new LectureTransform[2] { transform1, transform2 };
                            }
                            ...
                            else
                            {
                                ...
                                for (int venueIndex = 0; venueIndex < venues.Count; venueIndex++)
                                {
                                    ...
                                    bool improvedByNewLecture = timetableInitialFitness < timetable.GetFitness();
                                    if (revertIfWorse && !improvedByNewLecture)
                                    {
                                        //If the timetable has a better fitness value, keep it. Otherwise, reverse the operation
                                        timetable.UnassignLecture(lecture1);
                                        timetable.SetSlot(lecture1, lecture1Venue, lecture1Time);
                                    ...
                                    {
                                        if (!lecturesChanged.Contains(lecture1.GetNumber())) lecturesChanged.Add(lecture1.GetNumber());
                                        if (lecture2 != null && !lecturesChanged.Contains(lecture2.GetNumber())) lecturesChanged.Add(lecture2.GetNumber());
                                    }
        ...
        public static LectureTransform Mutation(Timetable timetable, LectureTransform transform)
        {
            return Mutation(timetable, transform, false);
        }
        public static LectureTransform Mutation(Timetable timetable)
        {
            return Mutation(timetable, null, false);
        }
