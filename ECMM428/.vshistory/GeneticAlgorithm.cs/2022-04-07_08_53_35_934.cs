...
namespace ECMM428
{
    ...
    {
        public static Timetable Execute(Timetable timetable1, double crossoverProbability, double fitnessMargin, int noToExpandSearchAfter, int noInMarginToStopAfter, int maxOnlineLectures, int maxAsynchronousLectures, int resets)
        {
            ...
            Timetable timetable1 = new Timetable(timetable1);
