...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void ModuleHardConstraint1Test()
        {
            ...
            List<Course> module2Lectures = module2.GetLectures();
            List<Course> module3Lectures = module3.GetLectures();
            ...
            double penalty = (timetable1.ModuleHardConstraint1(module1) + timetable1.ModuleHardConstraint1(module2) + timetable1.ModuleHardConstraint1(module3)) * timetable1.HARD_CONSTRAINT_PENALTY;
        ...
        public void ModuleHardConstraint2Test()
        {
            ...
            {
                penalty += timetable1.ModuleHardConstraint2(m) * timetable1.HARD_CONSTRAINT_PENALTY;
            }
            double expectedValue = 3 * timetable1.HARD_CONSTRAINT_PENALTY;
        ...
        public void LecturerHardConstraint1Test()
        {
            ...
            {
                penalty += timetable1.LecturerHardConstraint1(lec) * timetable1.HARD_CONSTRAINT_PENALTY;
            }
            double expectedValue = 3 * timetable1.HARD_CONSTRAINT_PENALTY;
        ...
        public void ModuleSoftConstraint1Test()
        {
            ...
            double penalty = 0;
            foreach (Module c in timetable1.GetLectures())
            {
                penalty += timetable1.CourseSoftConstraint1(c) * timetable1.COURSE_SOFT_CONSTRAINT_1_PENALTY;
            }
            double expectedValue = 100 * timetable1.COURSE_SOFT_CONSTRAINT_1_PENALTY;
            Assert.AreEqual(expectedValue, penalty, 0, "Soft constraint 1 test generated incorrect value");
        }
        [TestMethod]
        public void CourseSoftConstraint2Test()
        {
            ...
            double penalty = 0;
            foreach (Course c in timetable1.GetLectures())
            {
                penalty += timetable1.CourseSoftConstraint2(c) * timetable1.COURSE_SOFT_CONSTRAINT_2_PENALTY;
            }
            double expectedValue = 1;
            Assert.AreEqual(expectedValue, penalty, 0, "Soft constraint 2 test generated incorrect value");
        }
        [TestMethod]
        public void SoftConstraint3Test()
        {
            //Soft constraint 3: Each student's lectures on the same day should be held as close together as possible
            Timetable timetable1 = MainClass.Initialize(4, 1, 4, 1, 3, 7, 1, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            ...
            List<Course> module2Lectures = module2.GetLectures();
            List<Course> module3Lectures = module3.GetLectures();
            List<Course> module4Lectures = module3.GetLectures();
            List<Venue> timetable1Venues = timetable1.GetVenues();
        ...
        public void SoftConstraint4Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(4, 1, 4, 1, 3, 6, 1, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            Module module4 = timetable1.GetModules()[3];
            ...
            double penalty = timetable1.StudentSoftConstraint2(1, SOFT_CONSTRAINT_4_CONSECUTIVE_HOURS_ALLOWED);
            double expectedValue = 4;
            Assert.AreEqual(expectedValue, penalty, 0, "Soft constraint 4 test generated incorrect value");
        }
        [TestMethod]
        public void SoftConstraint5Test()
        {
            //Soft constraint 5: A module should not have multiple lectures on the same day
            Timetable timetable1 = MainClass.Initialize(3, 1, 3, 1, 1, 5, 1, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            List<Course> module1Lectures = module1.GetLectures();
            ...
            double penalty = timetable1.ModuleSoftConstraint2(1);
            double expectedValue = 4;
