        ...
        public static Timetable Execute(Timetable timetable, double fitnessMargin, int noToExpandSearchAfter, int noInMarginToStopAfter, int maxOnlineLectures, int maxAsynchronousLectures, int resets)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    {
                        if (!timetable1DifferentLectures.Contains(transform.GetLecture())) timetable1DifferentLectures.Add(transform.GetNumber());
                    }
                }
                ...
                else
                {
                    ...
                    {
                        if (!timetable2DifferentLectures.Contains(transform.GetLecture())) timetable2DifferentLectures.Add(transform.GetNumber());
                    }
                }
