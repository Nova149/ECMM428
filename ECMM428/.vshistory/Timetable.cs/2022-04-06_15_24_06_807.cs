...
namespace ECMM428
{
    ...
    public class Timetable
    {
        ...
        public double FitnessFunction()
        {
            ...
            int LECTURER_SOFT_CONSTRAINT_1_PENALTY = 1;
            ...
            double fitness = 0;
            fitness += ModuleHardConstraint1(HARD_CONSTRAINT_PENALTY);
            fitness += ModuleHardConstraint2(HARD_CONSTRAINT_PENALTY);
            fitness += LecturerHardConstraint1(HARD_CONSTRAINT_PENALTY);
            fitness += VenueConstraint1(LECTURER_SOFT_CONSTRAINT_1_PENALTY);
            fitness += CourseSoftConstraint1(SOFT_CONSTRAINT_2_PENALTY);
            fitness += StudentSoftConstraint1(SOFT_CONSTRAINT_3_PENALTY);
            fitness += StudentSoftConstraint2(SOFT_CONSTRAINT_4_PENALTY, SOFT_CONSTRAINT_4_CONSECUTIVE_HOURS_ALLOWED);
            fitness += ModuleSoftConstraint1(SOFT_CONSTRAINT_5_PENALTY);

            return fitness;
        }

        ///Hard constraint 1: All lectures of the same module must occur at different times
        public double ModuleHardConstraint1(int penalty)
        {
            int fitness = 0;
        ...
        public double ModuleHardConstraint2(int penalty)
        {
            int fitness = 0;
            List<Module> modules = GetModules();
        ...
        public double LecturerHardConstraint1(int penalty)
        {
        ...
        public double VenueConstraint1(double penalty)
        {
            List<Lecture> lectures = GetLectures();
            double fitness = 0;
            foreach (Lecture lecture in lectures)
        ...
        public double CourseSoftConstraint1(double penalty)
        {
            double fitness = 0;
        ...
        public double StudentSoftConstraint1(double penalty)
        {
            double fitness = 0;
            int noTimeslotsInDay = GetNoTimeslotsInDay();
            int totalGap = 0;
        ...
        public double StudentSoftConstraint2(double penalty, int consecutiveHoursAllowed)
        {
            int noTimeslotsInDay = GetNoTimeslotsInDay();
        ...
        public double ModuleSoftConstraint1(double penalty)
        {
            int noTimeslotsInDay = GetNoTimeslotsInDay();
