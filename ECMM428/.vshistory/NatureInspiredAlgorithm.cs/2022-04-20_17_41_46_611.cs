                        ...
                        for (int courseIndex = 0; courseIndex < courses.Count; courseIndex++)
                        {
                            ...
                            if (lecture1Venue == null)
                            {
                                ...
                                if (revertIfWorse)
                                {
                                    ...
                                    if (improvedByNewLectures && lecture2Swapped) transform2 = new LectureTransform(lecture2, null, null, lecture2Time, lecture1Time);
                                }
                                return new LectureTransform[2] { transform1, transform2 };
                            }
                                ...
                                for (int venueIndex = 0; venueIndex < venues.Count; venueIndex++)
                                {
                                    ...
                                    if (revertIfWorse && !improvedByNewLectures)
                                    {
                                        ...
                                        else if (!revertIfWorse)
                                        {
                                            //Generate transforms
                                            if (improvedByNewLectures) transform1 = new LectureTransform(lecture1, lecture1Venue, null, lecture1Time, lecture2Time);
                                            if (improvedByNewLectures && lecture2 != null) transform2 = new LectureTransform(lecture2, null, null, lecture2Time, lecture1Time);
                                        }
                                        return new LectureTransform[2] { transform1, transform2 };
                                    }
                                }
