            ...
            for (int moduleIndex = 0; moduleIndex < modules1.Count; moduleIndex++)
            {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //Generate transforms
                            transform1 = new LectureTransform(lecture1, lecture1Venue, newVenue1, lecture1Time, lecture2Time);
                            transform2 = new LectureTransform(lecture2, lecture2Venue, newVenue2, lecture2Time, lecture1Time);
                        }
                        return new LectureTransform[2] { transform1, transform2 };
                    }
                }
