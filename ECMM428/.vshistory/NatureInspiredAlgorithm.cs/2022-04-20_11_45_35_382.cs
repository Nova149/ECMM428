...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    else
                    {
                        ...
                        if (revertIfWorse)
                        {
                            ...
                            else if (timetable1lecturesChanged != null)
                            {
                                timetable1lecturesChanged.Add(lecture1.GetNumber());
                            }
                            ...
                            else if (timetable2lecturesChanged != null)
                            {
                                timetable2lecturesChanged.Add(lecture2.GetNumber());
                            }
                        }
                        else
                        {
                            //Add lectures to lecturesChanged
                            timetable1lecturesChanged.Add(lecture1.GetNumber());
                            timetable2lecturesChanged.Add(lecture1.GetNumber());
                        }
                        return;
                    }
                }
        ...
        public static void Mutation(Timetable timetable, List<Lecture> lecturesChanged, bool revertIfWorse)
        {
                            ...
                            else
                            {
                                ...
                                for (int venueIndex = 0; venueIndex < venues.Count; venueIndex++)
                                {
                                    ...
                                    if (revertIfWorse)
                                    {
                                        ...
                                        {
                                            lecturesChanged.Add(lecture1);
                                            if (lecture2 != null && lecturesChanged.Contains(lecture2)) lecturesChanged.Add(lecture2);
                                        }
                                    }
        ...
        public static void Mutation(Timetable timetable, List<Lecture> lecturesChanged)
        {
