...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static void Crossover(Timetable timetable1, Timetable timetable2, List<Lecture> timetable1LecturesChanged)
        {
            Crossover(timetable1, timetable2, timetable1LecturesChanged, false);
        }

        public static void Crossover(Timetable timetable1, Timetable timetable2)
        {
            Crossover(timetable1, timetable2, null, false);
        }
