            ...
            for (int moduleIndex = 0; moduleIndex < modules1.Count; moduleIndex++)
            {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    if (lecture1Venue == null || lecture2Venue == null)
                    {
                        ...
                        {
                            //Generate transforms
                            if (lecture1 != null) transform1 = new LectureTransform(lecture1, lecture1Venue, null, onlineLecture1Time, onlineLecture2Time);
                            if (lecture2 != null) transform2 = new LectureTransform(lecture2, lecture2Venue, null, onlineLecture2Time, onlineLecture1Time);
                        }
