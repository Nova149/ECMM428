...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void StudentSoftConstraint3Test()
        {
            ...
            List<Lecture> module1Lectures = module1.GetLectures();
            List<Venue> timetable1Venues = timetable.GetVenues();

            //Day 1
            timetable.SetSlot(module1, module1Lectures[0].GetDuration(), module1.GetCourse(), timetable1Venues[0], 0);

            //Day 2
            timetable.SetSlot(module1, module1Lectures[1].GetDuration(), module1.GetCourse(), timetable1Venues[0], 5);

            //Day 3
            timetable.SetSlot(module1, module1Lectures[2].GetDuration(), module1.GetCourse(), timetable1Venues[0], 11);
