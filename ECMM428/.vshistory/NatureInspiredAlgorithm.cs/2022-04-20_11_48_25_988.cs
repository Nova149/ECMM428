...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static void Crossover(Timetable timetable1, Timetable timetable2, List<int> timetable1lecturesChanged, List<int> timetable2lecturesChanged, bool revertIfWorse)
        {
        ...
        public static void Mutation(Timetable timetable, List<int> lecturesChanged)
        {
            Mutation(timetable, lecturesChanged, false);
        }
        public static void Mutation(Timetable timetable)
        {
            Mutation(timetable, null, false);
        }
