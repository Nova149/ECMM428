...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void ModuleHardConstraint1Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(1, 1, 3, 1, 7, 5, 1, 3, 100, 100, true);
            ...
            Assert.AreEqual(expectedValue, penalty, 0);
        }
        [TestMethod]
        public void ModuleHardConstraint2Test()
        {
            //All lectures should be assigned
            Timetable timetable1 = MainClass.Initialize(3, 1, 3, 1, 1, 5, 1, 3, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            List<Lecture> module1Lectures = module1.GetLectures();
        ...
        public void ModuleSoftConstraint1Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(1, 1, 1, 1, 3, 5, 100, 3, 100, 100, true);
        ...
        public void ModuleSoftConstraint2Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(3, 1, 3, 1, 1, 5, 1, 3, 100, 100, 0, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            List<Lecture> module1Lectures = module1.GetLectures();
        ...
        public void CourseSoftConstraint1Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(1, 1, 3, 1, 3, 5, 0, 3, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            List<Lecture> module1Lectures = module1.GetLectures();
        ...
        public void StudentSoftConstraint1Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(4, 1, 4, 1, 3, 7, 1, 3, 100, 100, 0, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
        ...
        [TestMethod]
        public void StudentSoftConstraint2Test()
        {
            //Each student should have no more than SOFT_CONSTRAINT_4_CONSECUTIVE_HOURS_ALLOWED hours of lectures in a row on the same day. Penalty scales up for each additional hour
            Timetable timetable1 = MainClass.Initialize(4, 1, 4, 1, 3, 6, 1, 3, 100, 100, 0, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            Module module4 = timetable1.GetModules()[3];
        ...
        [TestMethod]
        public void StudentSoftConstraint3Test()
        {
            ///Students should not have a lecture in the last slot of a day
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100, 0, true);
            ...
            //Day 2
            timetable.SetSlot(module1, module1Lectures[1].GetDuration(), module1.GetCourse(), timetableVenues[0], 5);

            //Day 3
            timetable.SetSlot(module1, module1Lectures[2].GetDuration(), module1.GetCourse(), timetableVenues[0], 11);


            double penalty = 0;
            foreach (Student s in timetable.GetStudents())
            {
                penalty += timetable.StudentSoftConstraint3(s);
            }
            double expectedValue = 2 * timetable.STUDENT_SOFT_CONSTRAINT_3_PENALTY;
            Assert.AreEqual(expectedValue, penalty, 0);
        }
        [TestMethod]
        public void StudentSoftConstraint4Test()
        {
            ...
            Timetable timetable = MainClass.Initialize(2, 1, 2, 1, 1, 6, 1, 3, 100, 100, 0, true);
            Module module1 = timetable.GetModules()[0];
            ...
            //Day 1
            timetable.SetSlot(module1, module1Lectures[0].GetDuration(), module1.GetCourse(), timetableVenues[0], 0);
            timetable.SetSlot(module1, module1Lectures[1].GetDuration(), module1.GetCourse(), timetableVenues[0], 1);

            //Day 2
            timetable.SetSlot(module1, module1Lectures[2].GetDuration(), module1.GetCourse(), timetableVenues[0], 5);

            //Day 3
            timetable.SetSlot(module2, module2Lectures[0].GetDuration(), module2.GetCourse(), timetableVenues[0], 11);

            //Day 4
            timetable.SetSlot(module2, module2Lectures[1].GetDuration(), module2.GetCourse(), timetableVenues[0], 12);
            timetable.SetSlot(module2, module2Lectures[2].GetDuration(), module2.GetCourse(), timetableVenues[0], 14);
            ...
            double expectedValue = 2 * timetable.STUDENT_SOFT_CONSTRAINT_4_PENALTY;
            Assert.AreEqual(expectedValue, penalty, 0);
        }
    }
}
