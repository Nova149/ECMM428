...
namespace ECMM428
{
    ...
    public class Timetable
    {
        ...
        public double FitnessFunction()
        {
            ...
            fitness += VenueConstraint1(SOFT_CONSTRAINT_1_PENALTY);
            ...
            fitness += ModuleSoftConstraint5(SOFT_CONSTRAINT_5_PENALTY);
        ...
        public double ModuleSoftConstraint5(double penalty)
        {
            int noTimeslotsInDay = GetNoTimeslotsInDay();
