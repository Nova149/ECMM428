...
namespace ECMM428
{
    ...
    public class Timetable
    {
        ...
        public double FitnessFunction()
        {
            ...
            fitness += ModuleSoftConstraint2(MODULE_SOFT_CONSTRAINT_1_PENALTY);
        ...
        public double ModuleConstraint1(Venue venue)
        {
            List<Lecture> lectures = venue.GetLectures();
            double fitness = 0;
            foreach (Lecture lecture in lectures)
            {
                if (lecture.GetVenue() != null)
        ...
        public double ModuleSoftConstraint2(double penalty)
        {
            int noTimeslotsInDay = GetNoTimeslotsInDay();
