...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        {
            for (int i = 0; i < times; i++) Crossover(timetable1, timetable2, null, true);
        }

        public static void Crossover(Timetable timetable1, Timetable timetable2, List<Lecture> lecturesChanged)
        {
            Crossover(timetable1, timetable2, lecturesChanged, false);
        }
