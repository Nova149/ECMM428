...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static LectureTransform[] Crossover(Timetable timetable1, Timetable timetable2, bool revertIfWorse)
        {
            ...
            LectureTransform[] transformArray = new LectureTransform[2] { transform1, transform2 };
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    else
                    {
                        ...
                        if (revertIfWorse)
                        {
                            ...
                            else if (timetable1lecturesChanged != null && !timetable1lecturesChanged.Contains(lecture1.GetNumber()))
                            {
                                timetable1lecturesChanged.Add(lecture1.GetNumber());
                            }
                            ...
                            else if (timetable2lecturesChanged != null && !timetable2lecturesChanged.Contains(lecture2.GetNumber()))
                            {
                                timetable2lecturesChanged.Add(lecture2.GetNumber());
                            }
                        }
                        else
                        {
                            //Add lectures to lecturesChanged
                            if (!timetable1lecturesChanged.Contains(lecture1.GetNumber())) timetable1lecturesChanged.Add(lecture1.GetNumber());
                            if (!timetable2lecturesChanged.Contains(lecture2.GetNumber())) timetable2lecturesChanged.Add(lecture2.GetNumber());
                        }
                        return transformArray;
                    }
                }
        ...
        {
            for (int i = 0; i < times; i++) Crossover(timetable1, timetable2, null, null, true);
        }

        public static void Crossover(Timetable timetable1, Timetable timetable2, List<int> timetable1LecturesChanged, List<int> timetable2LecturesChanged)
        {
            Crossover(timetable1, timetable2, timetable1LecturesChanged, timetable2LecturesChanged, false);
        }

        public static void Crossover(Timetable timetable1, Timetable timetable2)
        {
            Crossover(timetable1, timetable2, null, null, false);
        }
