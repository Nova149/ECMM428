...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static void Crossover(Timetable timetable1, Timetable timetable2, LectureTransform transform1, LectureTransform transform2, bool revertIfWorse)
        {
        ...
        public static void Mutation(Timetable timetable, LectureTransform transform)
        {
            Mutation(timetable, transform, false);
        }
