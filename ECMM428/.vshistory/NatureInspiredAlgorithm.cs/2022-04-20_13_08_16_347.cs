                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    if (lecture1Venue == null || lecture2Venue == null)
                    {
                        ...
                        if (revertIfWorse)
                        {
                            ...
                            {
                                transform1 = new LectureTransform(lecture1, lecture1Venue, null, onlineLecture1Time, onlineLecture2Time);
                            }
                            ...
                            {
                                transform2 = new LectureTransform(lecture2, lecture2Venue, null, onlineLecture2Time, onlineLecture1Time);
                            }
                        }
                        else
                        {
