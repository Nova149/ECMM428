            ...
            for (int moduleIndex = 0; moduleIndex < modules.Count; moduleIndex++)
            {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    if (lecture1Venue == null || lecture2Venue == null)
                    {
                        ...
                        {
                            List<Lecture> time1Lectures = new List<Lecture>(timetable2.GetOnlineLecturesFromModule(timetable2.GetModule(module.GetNumber())));
                            if (time1Lectures.Count > 1) lecture2 = time1Lectures.GetRandom();
                            else continue;
                        }
