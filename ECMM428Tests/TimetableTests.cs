...
namespace ECMM428Tests
{
    ...
    public class TimetableTests
    {
        ...
        public void GenericInitializationTest()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(5, 5, 5, 1, 20, 6, 500, 3, 100, 150);
        ...
        {
            Timetable timetable = MainClass.Initialize(1, 1, 2, 1, 5, 6, 1, 3, 100, 100, true);
            ...
            timetable.SetSlot(module1, module1Lectures[1].GetDuration(), module1.GetCourse(), timetableVenues[1], 0);
            timetable.SetSlot(module1, module1Lectures[2].GetDuration(), module1.GetCourse(), timetableVenues[2], 0);
            timetable.SetSlot(module2, module2Lectures[0].GetDuration(), module2.GetCourse(), timetableVenues[0], 1);
            timetable.SetSlot(module2, module2Lectures[1].GetDuration(), module2.GetCourse(), timetableVenues[3], 2);
            timetable.SetSlot(module2, module2Lectures[2].GetDuration(), module2.GetCourse(), timetableVenues[4], 3);
        ...
        {
            Timetable timetable = MainClass.Initialize(1, 1, 3, 1, 6, 6, 1, 3, 100, 100, true);
            Module module1 = timetable.GetModules()[0];
            Module module2 = timetable.GetModules()[1];
            ...
            Lecture lecture = module3Lectures[0];
            lecture.SetDuration(3);

            timetable.SetSlot(module1, module1Lectures[0].GetDuration(), module1.GetCourse(), timetableVenues[0], 3);
            timetable.SetSlot(module1, module1Lectures[1].GetDuration(), module1.GetCourse(), timetableVenues[1], 0);
            timetable.SetSlot(module1, module1Lectures[2].GetDuration(), module1.GetCourse(), timetableVenues[2], 0);
            timetable.SetSlot(module2, module2Lectures[0].GetDuration(), module2.GetCourse(), timetableVenues[3], 2);
            timetable.SetSlot(module2, module2Lectures[1].GetDuration(), module2.GetCourse(), timetableVenues[4], 3);

            List<Venue> actualResult = timetable.GetAvailableVenuesAtTime(lecture, 0);
            List<Venue> expectedResult = new List<Venue> { timetableVenues[0], timetableVenues[4], timetableVenues[5] };
            CollectionAssert.AreEqual(expectedResult, actualResult);
        }
        [TestMethod]
        public void SetSlotTest()
        {
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100);
            Lecture lecture = timetable.GetLectures()[0];
            lecture.SetDuration(3);
            Module module = lecture.GetModule();

            timetable.SetSlot(lecture, timetable.GetVenues()[0], 1);
            Module[,,] array = timetable.GetTimetable();
            bool actualResult = array[0, 0, 0] == null && array[0, 0, 1] == module && array[0, 0, 2] == module && array[0, 0, 3] == module && array[0, 0, 4] == null && array[0, 0, 5] == null;
            bool expectedResult = true;
            Assert.AreEqual(expectedResult, actualResult);
        }
        [TestMethod]
        public void MakeLectureOnlineTest()
        {
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100);
            Lecture lecture = timetable.GetLectures()[0];
            lecture.SetDuration(3);
            ...
            Module[,,] array = timetable.GetTimetable();
            bool actualResult = array[0, 0, 0] == null && array[0, 0, 1] == null && array[0, 0, 2] == null && array[0, 0, 3] == null && array[0, 0, 4] == null && array[0, 0, 5] == null 
                && lecture.GetTime() == 1 && lecture.GetVenue() == null;
            bool expectedResult = true;
            Assert.AreEqual(expectedResult, actualResult);
        }
        [TestMethod]
        public void MakeLectureAsynchronousTest()
        {
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100);
            Lecture lecture = timetable.GetLectures()[0];
            lecture.SetDuration(3);
        ...
        public void LectureCanBeAllocatedAtTest1()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100, true);
        ...
        public void LectureCanBeAllocatedAtTest4()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100);
            Module module1 = timetable1.GetModules()[0];
            List<Lecture> module1Lectures = module1.GetLectures();
            List<Venue> timetable1Venues = timetable1.GetVenues();
        ...
        [TestMethod]
        public void MaxFreeSlotForRoomTest()
        {
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100);
            Lecture lecture = timetable.GetLectures()[0];
            lecture.SetDuration(1);

            timetable.SetSlot(lecture, timetable.GetVenues()[0], 1);
            int actualValue1 = timetable.MaxFreeSlotForRoom(timetable.GetVenues()[0], 1);
            int actualValue2 = timetable.MaxFreeSlotForRoom(timetable.GetVenues()[0], 2);
        ...
        [TestMethod]
        public void UnassignLectureTest()
        {
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 1, 6, 1, 3, 100, 100);
            Lecture lecture = timetable.GetLectures()[0];
            Module module = lecture.GetModule();
            ...
            Module[,,] array = timetable.GetTimetable();
            bool actualResult = array[0, 0, 0] == null && array[0, 0, 1] == null && array[0, 0, 2] == null && array[0, 0, 3] == null && array[0, 0, 4] == null && array[0, 0, 5] == null
                && lecture.GetTime() == -1 && lecture.GetVenue() == null && module.GetUnassignedLectures().Contains(lecture);
            bool expectedResult = true;
            Assert.AreEqual(expectedResult, actualResult);
        }
