...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void StudentSoftConstraint4Test()
        {
            ...
            //Day 3
            timetable.SetSlot(module1, module2Lectures[0].GetDuration(), module1.GetCourse(), timetableVenues[0], 11);

            //Day 4
            timetable.SetSlot(module1, module2Lectures[1].GetDuration(), module1.GetCourse(), timetableVenues[0], 12);
            timetable.SetSlot(module1, module2Lectures[2].GetDuration(), module1.GetCourse(), timetableVenues[0], 14);
