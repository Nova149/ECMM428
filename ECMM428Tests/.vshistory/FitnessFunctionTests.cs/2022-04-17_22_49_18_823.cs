...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void HardConstraint3Test()
        {
            ...
            double penalty = 0;
            foreach (Lecturer lec in timetable1.GetModules())
            {
                penalty += timetable1.ModuleHardConstraint2(lec) * timetable1.HARD_CONSTRAINT_PENALTY;
            }
        ...
        public void SoftConstraint1Test()
        {
            ...
            double penalty = timetable1.VenueConstraint1(1);
