...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static void Mutation(Timetable timetable, List<int> lecturesChanged, bool revertIfWorse)
        {
                    ...
                    for (int lecture1Index = 0; lecture1Index < time1Lectures.Count; lecture1Index++)
                    {
                        ...
                        for (int courseIndex = 0; courseIndex < courses.Count; courseIndex++)
                        {
                            ...
                            if (lecture1Venue == null)
                            {
                                ...
                                //Generate transforms
                                if (improvedByNewLectures) transform1 = new LectureTransform(lecture1, lecture1Venue, newVenue1, lecture1Time, lecture2Time);
                                if (lecture2Swapped) transform2 = new LectureTransform(lecture2, lecture2Venue, newVenue2, lecture2Time, lecture1Time);
                                return new LectureTransform[2] { transform1, transform2 };
                            }
