    ...
    public class MainClass
    {
        static void Main(string[] args)
        {
            ...
            Timetable timetable = MainClass.Initialize(NO_MODULES_PER_STUDENT, NO_COURSES, NO_MODULES_PER_COURSE, NO_LECTURERS_PER_COURSE, 
                NO_ROOMS, NO_TIMESLOTS_PER_DAY, NO_STUDENTS, HOURS_OF_LECTURES_PER_MODULE, MIN_VENUE_CAPACITY, MAX_VENUE_CAPACITY, SEED, false);
            ...
            //TestRemoteInitializationAlgorithm("Genetic", "Online", timetable, 0, 0.55, 1, 1000, 0, 0, 0.06, 50);
        }
