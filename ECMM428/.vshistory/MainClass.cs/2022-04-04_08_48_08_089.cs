...
namespace ECMM428
{
    public class MainClass
    {
        ...
        public static Timetable Initialize(int noModulesPerStudent, int noCourses, int noModulesPerCourse, int noLecturersPerCourse, int noRooms, int noTimeslotsPerDay, int noStudents, int minVenueCapacity, int maxVenueCapacity, bool allLecturesLastOneHour, int seed)
        {
            //Constants
