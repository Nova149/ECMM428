        ...
        public static Timetable Execute(Timetable timetable, double fitnessMargin, int noToExpandSearchAfter, int noInMarginToStopAfter, int maxOnlineLectures, int maxAsynchronousLectures, int resets)
        {
            ...
            while (true)
            {
                ...
                if (transforms1 != null) {
                    ...
                    if(transforms1[1] != null) timetable2TransformArray.AddTransform(transforms1[1]);
                }
                if (transforms2 != null)
                {
                    if (transforms2[0] != null) timetable1TransformArray.AddTransform(transforms2[0]);
