...
namespace ECMM428
{
    ...
    public class LectureTransformArray
    {
        ...
        public void JoinArrays(LectureTransformArray transform2, int finalNo)
        {
            Dictionary<int, LectureTransform> dict = transform2.GetArray();
            foreach (int key in dict.Keys)
            {
                int[] transform = dict[key].GetTransform();
