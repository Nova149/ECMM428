...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void StudentSoftConstraint3Test()
        {
            ...
            //Day 2
            timetable.SetSlot(module1, module1Lectures[1].GetDuration(), module1.GetCourse(), timetable1Venues[0], 6);

            //Day 3
            timetable.SetSlot(module1, module1Lectures[2].GetDuration(), module1.GetCourse(), timetable1Venues[0], 12);
