                            ...
                            else
                            {
                                ...
                                for (int venueIndex = 0; venueIndex < venues.Count; venueIndex++)
                                {
                                    ...
                                    if (venuesForLecture1.Count == 0 || (venuesForLecture2 != null && venuesForLecture2.Count == 0))
                                    {
                                        ...
                                        if (lecture2 != null)
                                        {
                                            timetable.SetSlot(lecture2.GetModule(), lecture2.GetDuration(), lecture2Course, lecture2Venue, lecture2Time);
                                        }
                                        continue;
                                    }

                                    //Perform swap
                                    timetable.SetSlot(lecture1Module, lecture1.GetDuration(), lecture1Course, venuesForLecture1.GetRandom(), lecture2Time);

                                    if (lecture2 != null)
                                    {
                                        timetable.SetSlot(lecture2.GetModule(), lecture2.GetDuration(), lecture2Course, venuesForLecture2.GetRandom(), lecture1Time);
                                        timetable.RecalculateFitnessValues(lecture2);
                                    }
                                    timetable.RecalculateFitnessValues(lecture1);
