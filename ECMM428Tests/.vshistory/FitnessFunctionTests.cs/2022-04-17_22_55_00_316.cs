...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void ModuleSoftConstraint1Test()
        {
            ...
            foreach (Module m in timetable1.GetModules())
            {
                penalty += timetable1.ModuleSoftConstraint1(m) * timetable1.MODULE_SOFT_CONSTRAINT_1_PENALTY;
            }
        ...
        public void StudentSoftConstraint1Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(0, 4, 1, 4, 1, 3, 7, 1, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            ...
            {
                penalty += timetable1.StudentSoftConstraint1(s) * timetable1.STUDENT_SOFT_CONSTRAINT_1_PENALTY;
            }
        ...
        public void StudentSoftConstraint2Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(0, 4, 1, 4, 1, 3, 6, 1, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            Module module4 = timetable1.GetModules()[3];
            ...
            double penalty = 0;
            foreach (Student s in timetable1.GetLectures())
            {
                penalty += timetable1.CourseSoftConstraint1(s) * timetable1.COURSE_SOFT_CONSTRAINT_1_PENALTY;
            }
