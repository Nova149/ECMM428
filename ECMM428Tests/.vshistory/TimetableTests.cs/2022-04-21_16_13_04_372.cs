...
namespace ECMM428Tests
{
    ...
    public class TimetableTests
    {
        ...
        [TestMethod]
        public void GetAvailableVenuesAtTimeTest()
        {
            Timetable timetable = MainClass.Initialize(1, 1, 1, 1, 5, 6, 1, 100, 100);
            ...
            timetable.SetSlot(module1, module1Lectures[0].GetDuration(), module1.GetCourse(), timetableVenues[0], 1);
            timetable.SetSlot(module1, module1Lectures[0].GetDuration(), module1.GetCourse(), timetableVenues[3], 2);
            timetable.SetSlot(module1, module1Lectures[0].GetDuration(), module1.GetCourse(), timetableVenues[4], 3);
        }
