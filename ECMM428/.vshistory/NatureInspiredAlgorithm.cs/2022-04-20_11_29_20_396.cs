...
namespace ECMM428
{
    ...
    public class NatureInspiredAlgorithm
    {
        ...
        public static void Crossover(Timetable timetable1, Timetable timetable2, List<Lecture> lecturesChanged, bool revertIfWorse)
        {
                ...
                for (int lectureIndex = 0; lectureIndex < lectures1.Count; lectureIndex++)
                {
                    ...
                    else
                    {
                        ...
                        } else
                        {
                            ...
                            if (lecturesChanged != null)
                            {
                                if (improvedByNewLecture1) lecturesChanged.Add(lecture1);
                                if (improvedByNewLecture2) lecturesChanged.Add(lecture2);
                            }
                        }
                        return;
                    }
