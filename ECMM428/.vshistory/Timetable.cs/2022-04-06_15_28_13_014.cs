...
namespace ECMM428
{
    ...
    public class Timetable
    {
        ...
        public double FitnessFunction()
        {
            ...
            double MODULE_SOFT_CONSTRAINT_1_PENALTY = 3;
            ...
            fitness += StudentSoftConstraint2(STUDENT_SOFT_CONSTRAINT_2_PENALTY, STUDENT_SOFT_CONSTRAINT_2_CONSECUTIVE_HOURS_ALLOWED);
            fitness += ModuleSoftConstraint1(MODULE_SOFT_CONSTRAINT_1_PENALTY);
        ...
        public double VenueConstraints(Venue venue)
        {
