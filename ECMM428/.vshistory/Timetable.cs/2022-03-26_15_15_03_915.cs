...
namespace ECMM428
{
    ...
    public class Module
    {
        ...
        public Module(int moduleNumber, List<Student> enrolledStudents, Lecturer lecturer, List<Lecture> lectures, Course course, List<Lecture> unassignedLectures)
        {
            this.moduleNumber = moduleNumber;
        ...
        public Module(int moduleNumber, List<Student> enrolledStudents, Lecturer lecturer, List<Lecture> lectures, Course course, List<Lecture> unassignedLectures, int noOnlineLectures, int noAsynchronousLectures)
        {
            this.moduleNumber = moduleNumber;
            this.enrolledStudents = enrolledStudents;
            this.lecturer = lecturer;
    ...
    public class Timetable
    {
        ...
        public Timetable(Timetable timetable)
        {
            ...
            //Copy students
            List<Student> newStudents = timetable.GetStudents().ConvertAll(student => new Student(student.GetNumber(), student.GetYearOfStudy(), new List<Module>()));

            //Copy lecturers
            List<Lecturer> newLecturers = timetable.GetLecturers().ConvertAll(lecturer => new Lecturer(lecturer.GetNumber(), new List<Module>(), null));
            ...
            {
                //Copy course
                Course newCourse = new Course(c.GetNumber(), null, new List<Lecturer>());
                ...
                foreach (Module m in c.GetModules())
                {
                    ...
                    Module newModule = new Module(m.GetNumber(), null, moduleLecturer, null, newCourse, null, m.GetNoOnlineLectures(), m.GetNoAsynchronousLectures());
        ...
        ///Initialize timetable by placing lectures in random timeslotes
        public void GenericInitialization()
        {
            ...
            for (int i = 0; i < unassignedLectures.Count; i++)
            {
                ...
                for (int j = 0; j < timeslots.Count; j++)
                {
                    ...
                    {
                        Venue venue = availableVenues.GetRandom();
