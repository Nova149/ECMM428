...
namespace ECMM428
{
    ...
    public class Timetable
    {
        ...
        public double StudentSoftConstraint4(Student student)
        {
            ...
            bool moreThanOneLectureOnCurrentDay = false;
            bool newDay = false;
            ...
            for(int i = 1; i < lectures.Count; i++)
            {
                ...
                {
                    moreThanOneLectureOnCurrentDay = false;
                    newDay = true;
                } else
                {
                    moreThanOneLectureOnCurrentDay = true;
                }

                if (!newDay && !moreThanOneLectureOnCurrentDay)
                {
                    violations++;
                }
                newDay = false;
