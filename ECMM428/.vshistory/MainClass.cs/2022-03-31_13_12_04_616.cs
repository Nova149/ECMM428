...
namespace ECMM428
{
    public class MainClass
    {
        static void Main(string[] args)
        {
            ...
            TestAlgorithmOnline("Genetic", timetable, 0, 0.125, 1, 1000, 0, 2, 1, 5);
        ...
        public static void TestAlgorithmExpand(string algorithm, Timetable initialTimetable, double seed, double crossoverProbability, double fitnessMargin, int noInMarginToStopAfter, int initialValue, int finalValue, int step, int noRunsPerStep)
        {
        ...
        public static void TestGeneticAlgorithmCrossoverProbability(Timetable initialTimetable, double fitnessMargin, double seed, int noInMarginToStopAfter, double initialValue, double finalValue, double step, int noRunsPerStep)
        {
            int noSteps = (int)Math.Floor((double)(finalValue - initialValue) / step) + 1;
            double[,] results = new double[noSteps, 3];
            var stopwatch = new System.Diagnostics.Stopwatch();
        ...
        public static void TestAlgorithmOnline(string algorithm, Timetable initialTimetable, double seed, double fitnessMargin, int noInMarginToStopAfter, int initialValue, int finalValue, int step, int noRunsPerStep)
        {
        ...
        public static void TestAlgorithmOnline(string algorithm, Timetable initialTimetable, double seed, double crossoverProbability, double fitnessMargin, int noInMarginToStopAfter, int initialValue, int finalValue, int step, int noRunsPerStep)
        {
            int noSteps = (int)Math.Floor((double)(finalValue - initialValue) / step) + 1;
        ...
        public static void TestAlgorithmAsynchronous(string algorithm, Timetable initialTimetable, double seed, double crossoverProbability, double fitnessMargin, int noInMarginToStopAfter, int initialValue, int finalValue, int step, int noRunsPerStep)
        {
            int noSteps = (int)Math.Floor((double)(finalValue - initialValue) / step) + 1;
            double[,] results = new double[noSteps, 5];
            var stopwatch = new System.Diagnostics.Stopwatch();
