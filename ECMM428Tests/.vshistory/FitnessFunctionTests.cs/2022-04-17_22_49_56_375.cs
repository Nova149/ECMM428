...
namespace ECMM428Tests
{
    ...
    {
        [TestMethod]
        public void HardConstraint1Test()
        {
        ...
        [TestMethod]
        public void HardConstraint2Test()
        {
        ...
        [TestMethod]
        public void HardConstraint3Test()
        {
        ...
        [TestMethod]
        public void SoftConstraint1Test()
        {
            ...
            double penalty = 0;
            foreach (Lecture l in timetable1.GetLecturers())
            {
                penalty += timetable1.LecturerHardConstraint1(l) * timetable1.HARD_CONSTRAINT_PENALTY;
            }
