...
namespace ECMM428
{
    ...
    public class LectureTransformArray
    {
        ...
        public void PerformAllTransforms(Timetable timetable, int finalNo)
        {
        ...
        public void JoinArrays(LectureTransformArray Arraytransform2, int finalNo)
        {
            Dictionary<int, LectureTransform> array2 = Arraytransform2.GetArray();
