...
namespace ECMM428Tests
{
    ...
    public class FitnessFunctionTests
    {
        ...
        public void StudentSoftConstraint2Test()
        {
            ...
            foreach (Student s in timetable1.GetStudents())
            {
                penalty += timetable1.StudentSoftConstraint2(s) * timetable1.STUDENT_SOFT_CONSTRAINT_2_PENALTY;
            }
        ...
        public void ModuleSoftConstraint2Test()
        {
            ...
            Timetable timetable1 = MainClass.Initialize(0, 3, 1, 3, 1, 1, 5, 1, 100, 100, true);
            Module module1 = timetable1.GetModules()[0];
            Module module2 = timetable1.GetModules()[1];
            Module module3 = timetable1.GetModules()[2];
            List<Course> module1Lectures = module1.GetLectures();
            ...
            double penalty = 0;
            foreach (Module m in timetable1.GetStudents())
            {
                penalty += timetable1.ModuleSoftConstraint2(m) * timetable1.STUDENT_SOFT_CONSTRAINT_2_PENALTY;
            }
